...
class ExperimentRunner(Node):
    def __init__(self):
        ...
        self.current_wp = 0
        self.wp_threshold = 10.0 # Increased to 10.0 to allow for large calibration offset
        
        self.get_logger().info("Experiment Runner Started")
    ...
    def save_data(self):
        path = '/home/pb/Documents/R2/experiment_data.csv'
