...
def analyze(csv_file):
    ...
    print("Experiment1 Performance Report")
    print("-----------------------------------------")
    ...
    plt.tight_layout()
    plt.savefig('/home/pb/Documents/R2/Experiment1/experiment1_results.png')
    print("Plots saved to /home/pb/Documents/R2/Experiment1/experiment1_results.png")

if __name__ == "__main__":
    if len(sys.argv) > 1:
        analyze(sys.argv[1])
    else:
        analyze('/home/pb/Documents/R2/Experiment1/experiment_1_data.csv')
