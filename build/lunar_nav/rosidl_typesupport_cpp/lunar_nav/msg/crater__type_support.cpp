...
static const _Crater_type_support_symbol_names_t _Crater_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lunar_nav, msg, Crater)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lunar_nav, msg, Crater)),
  }
};
...
{
  return &::lunar_nav::msg::rosidl_typesupport_cpp::Crater_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lunar_nav, msg, Crater)() {
  return get_message_type_support_handle<lunar_nav::msg::Crater>();
}
