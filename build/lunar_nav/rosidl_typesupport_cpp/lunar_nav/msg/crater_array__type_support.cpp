...
static const _CraterArray_type_support_symbol_names_t _CraterArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lunar_nav, msg, CraterArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lunar_nav, msg, CraterArray)),
  }
};
...
{
  return &::lunar_nav::msg::rosidl_typesupport_cpp::CraterArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lunar_nav, msg, CraterArray)() {
  return get_message_type_support_handle<lunar_nav::msg::CraterArray>();
}
