...
bool lunar_nav__msg__crater__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lunar_nav.msg._crater.Crater", full_classname_dest, 28) == 0);
  }
  lunar_nav__msg__Crater * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of Crater */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lunar_nav.msg._crater");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Crater");
